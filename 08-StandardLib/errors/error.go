...
//
//Well, we are handling the error twice by logging it first
// and then by returning it to the caller of this function.
//Probably one of your team colleagues will use this function and when an error returns,
// he will log the error again. Then an error nightmare occurs in the system log
